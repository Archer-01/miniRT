...
canvas_import_png_INC		:= $(canvas_INC)
intersect_cone_INC			:= $(shape_INC)
orientation_INC				:= $(matrix_INC)
parsing_INC					:= parsing.h main.h
parse_ambient_INC			:= $(parsing_INC)
parse_camera_INC			:= $(parsing_INC)
parse_checker_INC			:= $(parsing_INC)
parse_color_INC				:= $(parsing_INC)
parse_cone_INC				:= $(parsing_INC)
parse_cylinder_INC			:= $(parsing_INC)
parse_int_INC				:= $(parsing_INC)
parse_light_INC				:= $(parsing_INC)
parse_pattern_INC			:= $(parsing_INC)
parse_phong_INC				:= $(parsing_INC)
parse_plane_INC				:= $(parsing_INC)
parse_ratio_INC				:= $(parsing_INC)
parse_sphere_INC			:= $(parsing_INC)
parse_texture_INC			:= $(parsing_INC)
parse_tuple_INC				:= $(parsing_INC)
parse_world_INC				:= $(parsing_INC)
parse_INC					:= $(parsing_INC)
utils_1_INC					:= $(utils_INC)
utils_2_INC					:= $(utils_INC)
main_INC					:= main.h $(parsing_INC)
